        ...
        <div className=' py-10 md:flex md:flex-row-reverse items-center md:py-24 justify-between'>
            <div className="hero-image w-full" >
                <div className="image w-[300px] h-[200px] my-4 mx-auto p-4 relative md:mr-0 md:h-[497px] md:w-[450px] ">
                    <div className='bg-[#4e4236] absolute top-0 left-0 h-[200px] md:h-[400px] w-full rounded -z-10' data-aos="fade-down"></div>
                    <img className='block m-auto md:h-[400px] w-[400px] rounded' data-aos="fade-up" src={heroImage} alt="" />
                </div>
            </div>
            <div className="hero-text md:text-left my-24 md:my-0" data-aos="fade-right">
