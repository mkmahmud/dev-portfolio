        ...
        <div>
            ...
            <div className=' py-10 md:flex md:flex-row-reverse items-center  justify-between'>
                <div className="hero-text md:text-left w-full">
                    <h2 className='text-[32px] font-bold text-[#343D68]'>I am senior software engineer Specialized in Java and JavaScript</h2>
                ...
                <div className="hero-image w-full md:mx-10">
                    <div className="image w-[300px] my-4 mx-auto p-4 relative md:mr-0 md:h-[497px] md:w-[411px] ">
                        <div className='bg-[#4e4236] absolute top-0 left-0 h-[250px] md:h-[400px] w-full rounded -z-10' data-aos="fade-down"></div>
                        <img className='block m-auto md:h-[400px] w-[400px] rounded' data-aos="fade-up" src={heroImage} alt="" />
                    </div>
                </div>
